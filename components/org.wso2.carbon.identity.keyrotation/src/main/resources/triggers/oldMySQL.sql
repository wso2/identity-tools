...
CREATE TRIGGER oauth2_code_sync_insert
    ...
    FOR EACH ROW
BEGIN
    INSERT INTO IDN_OAUTH2_AUTHORIZATION_CODE_TEMP (CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID,
                                                    CALLBACK_URL, SCOPE, AUTHZ_USER, TENANT_ID, USER_DOMAIN,
                                                    TIME_CREATED, VALIDITY_PERIOD, STATE, TOKEN_ID, SUBJECT_IDENTIFIER,
                                                    PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD,
                                                    AUTHORIZATION_CODE_HASH, IDP_ID, AVAILABILITY)
...
BEGIN
    INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_TEMP (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER,
                                              ...
                                              REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE,
                                              ...
                                              VALUES (NEW.TOKEN_ID, NEW.ACCESS_TOKEN, NEW.REFRESH_TOKEN,
                                                      ...
                                                      NEW.USER_DOMAIN, NEW.USER_TYPE, NEW.GRANT_TYPE, NEW.TIME_CREATED,
...
BEGIN
    INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_TEMP (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER,
                                              ...
                                              REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD,
                                              REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE,
                                              TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH,
                                              REFRESH_TOKEN_HASH, IDP_ID, TOKEN_BINDING_REF, AVAILABILITY)
                                              VALUES (OLD.TOKEN_ID, OLD.ACCESS_TOKEN, OLD.REFRESH_TOKEN,
                                                      OLD.CONSUMER_KEY_ID, OLD.AUTHZ_USER, OLD.TENANT_ID,
                                                      OLD.USER_DOMAIN, OLD.USER_TYPE, OLD.GRANT_TYPE, OLD.TIME_CREATED,
                                                      OLD.REFRESH_TOKEN_TIME_CREATED, OLD.VALIDITY_PERIOD,
                                                      OLD.REFRESH_TOKEN_VALIDITY_PERIOD, OLD.TOKEN_SCOPE_HASH,
                                                      OLD.TOKEN_STATE, OLD.TOKEN_STATE_ID, OLD.SUBJECT_IDENTIFIER,
                                                      OLD.ACCESS_TOKEN_HASH, OLD.REFRESH_TOKEN_HASH, OLD.IDP_ID,
                                                      OLD.TOKEN_BINDING_REF, 0);
END //
DELIMITER ;
