...
CREATE TABLE IDN_IDENTITY_USER_DATA_TEMP (
                                             SYNC_ID NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE IDN_OAUTH2_AUTHORIZATION_CODE_TEMP (
                                                    SYNC_ID NUMBER GENERATED ALWAYS as
...
INSERT INTO IDN_OAUTH2_AUTHORIZATION_CODE_TEMP (CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE,
                                                ...
                                                VALUES (:NEW.CODE_ID, :NEW.AUTHORIZATION_CODE, :NEW.CONSUMER_KEY_ID,
                                                        :NEW.CALLBACK_URL,
                                                                                                                                                                                                                                                                                                                                   :NEW.SCOPE, :NEW.AUTHZ_USER, :NEW.TENANT_ID, :NEW.USER_DOMAIN, :NEW.TIME_CREATED,
                                                                                                                                                                                                                                                                                                                                   :NEW.VALIDITY_PERIOD, :NEW.STATE, :NEW.TOKEN_ID, :NEW.SUBJECT_IDENTIFIER,
                                                                                                                                                                                                                                                                                                                                   :NEW.PKCE_CODE_CHALLENGE, :NEW.PKCE_CODE_CHALLENGE_METHOD, :NEW.AUTHORIZATION_CODE_HASH,
                                                                                                                                                                                                                                                                                                                                   :NEW.IDP_ID, 1);
END;
...
INSERT INTO IDN_OAUTH2_AUTHORIZATION_CODE_TEMP (CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE,
                                                ...
                                                VALUES (:NEW.CODE_ID, :NEW.AUTHORIZATION_CODE, :NEW.CONSUMER_KEY_ID,
                                                        :NEW.CALLBACK_URL,
                                                                                                                                                                                                                                                                                                                                   :NEW.SCOPE, :NEW.AUTHZ_USER, :NEW.TENANT_ID, :NEW.USER_DOMAIN,
                                                                                                                                                                                                                                                                                                                                   :NEW.TIME_CREATED, :NEW.VALIDITY_PERIOD, :NEW.STATE, :NEW.TOKEN_ID,
...
INSERT INTO IDN_OAUTH2_AUTHORIZATION_CODE_TEMP (CODE_ID, AUTHORIZATION_CODE, CONSUMER_KEY_ID, CALLBACK_URL, SCOPE,
                                                ...
                                                VALUES (:OLD.CODE_ID, :OLD.AUTHORIZATION_CODE, :OLD.CONSUMER_KEY_ID,
                                                        :OLD.CALLBACK_URL,
                                                                                                                                                                                                                                                                                                                                   :OLD.SCOPE, :OLD.AUTHZ_USER, :OLD.TENANT_ID, :OLD.USER_DOMAIN,
                                                                                                                                                                                                                                                                                                                                   :OLD.TIME_CREATED, :OLD.VALIDITY_PERIOD, :OLD.STATE, :OLD.TOKEN_ID,
                                                                                                                                                                                                                                                                                                                                   :OLD.SUBJECT_IDENTIFIER, :OLD.PKCE_CODE_CHALLENGE, :OLD.PKCE_CODE_CHALLENGE_METHOD,
...
FOR EACH ROW
BEGIN
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_TEMP (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER,
                                          ...
                                          AVAILABILITY) VALUES (:NEW.TOKEN_ID, :NEW.ACCESS_TOKEN, :NEW.REFRESH_TOKEN,
                                                                :NEW.CONSUMER_KEY_ID,
                                                                                                                                                                                                                                                                                                                                                                                                                  :NEW.AUTHZ_USER, :NEW.TENANT_ID, :NEW.USER_DOMAIN, :NEW.USER_TYPE,
                                                                                                                                                                                                                                                                                                                                                                                                                  :NEW.GRANT_TYPE, :NEW.TIME_CREATED, :NEW.REFRESH_TOKEN_TIME_CREATED,
                                                                                                                                                                                                                                                                                                                                                                                                                  :NEW.VALIDITY_PERIOD, :NEW.REFRESH_TOKEN_VALIDITY_PERIOD, :NEW.TOKEN_SCOPE_HASH,
                                                                                                                                                                                                                                                                                                                                                                                                                  :NEW.TOKEN_STATE, :NEW.TOKEN_STATE_ID, :NEW.SUBJECT_IDENTIFIER,
                                                                                                                                                                                                                                                                                                                                                                                                                  :NEW.ACCESS_TOKEN_HASH, :NEW.REFRESH_TOKEN_HASH, :NEW.IDP_ID, :NEW.TOKEN_BINDING_REF, 1);
END;
...
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_TEMP (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, TENANT_ID,
                                          ...
                                          TOKEN_STATE_ID, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH,
                                          IDP_ID, TOKEN_BINDING_REF, AVAILABILITY)
                                          VALUES (:OLD.TOKEN_ID, :OLD.ACCESS_TOKEN, :OLD.REFRESH_TOKEN,
                                                  :OLD.CONSUMER_KEY_ID,
                                                                                                                                                                                                                                                                                                                                                                                                                  :OLD.AUTHZ_USER, :OLD.TENANT_ID, :OLD.USER_DOMAIN, :OLD.USER_TYPE,
                                                                                                                                                                                                                                                                                                                                                                                                                  :OLD.GRANT_TYPE, :OLD.TIME_CREATED, :OLD.REFRESH_TOKEN_TIME_CREATED,
                                                                                                                                                                                                                                                                                                                                                                                                                  :OLD.VALIDITY_PERIOD, :OLD.REFRESH_TOKEN_VALIDITY_PERIOD, :OLD.TOKEN_SCOPE_HASH,
                                                                                                                                                                                                                                                                                                                                                                                                                  :OLD.TOKEN_STATE, :OLD.TOKEN_STATE_ID, :OLD.SUBJECT_IDENTIFIER,
                                                                                                                                                                                                                                                                                                                                                                                                                  :OLD.ACCESS_TOKEN_HASH, :OLD.REFRESH_TOKEN_HASH, :OLD.IDP_ID, :OLD.TOKEN_BINDING_REF, 0);
END;
